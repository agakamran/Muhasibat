...
import {
  CardsModule, DropdownModule, NavbarModule, ButtonsModule,
  ...
  TableModule, WavesModule, MDBBootstrapModule, ChartsModule
...
@NgModule({
  ...
  imports: [
    ...
    WavesModule.forRoot(), MDBBootstrapModule.forRoot(),
    //,LayoutModule  
  ],
  exports: [
    CommonModule,
